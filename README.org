...
|------------+---------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------|
| (core)     | always  | reqwest, tokio-tungstenite, opus, rubato, symphonia, ... | Transcription providers (Mistral/OpenAI batch + realtime WS), resampler, Opus/OGG encode, file decode, config, cache |
| ~parakeet~ | yes     | sherpa-onnx (static C++), tar, bzip2                     | Local ASR backend (Parakeet TDT, CPU)                                                                                |
| ~capture~  | yes     | pipewire, cpal, libpulse-binding                         | Live mic/monitor capture, BT headset HFP switch, indicator tones                                                     |
| ~ui~       | yes     | gtk4, x11rb, png, fontdue, dark-light, ...               | X11 overlay, visualizers, clipboard/paste, picker, recordings browser                                                |
